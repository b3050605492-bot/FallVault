...
// - 本地项目构建（exe 在 target\release 或 target\debug 下）：改为便携模式，数据库存 exe 同级 data\，
//   与日常版完全隔离，避免本地构建数据污染正式保险库
let cache: string | null = null;

function isProjectBuild(exeDir: string): boolean {
